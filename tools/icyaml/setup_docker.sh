...
chmod +x "$SCRIPT_DIR/analyze_cfa_outliers_docker.sh"
...
alias icyaml-analyze-cfa="icyaml-docker analyze-cfa"
alias icyaml-catalog-cfa="icyaml-docker catalog-cfa"
...
echo "   ./docker-run.sh outliers --dir /data/cfa --threshold 50"
echo "   ./analyze_cfa_outliers_docker.sh"
echo ""
echo "2. (Optional) Source the aliases for easier usage:"
echo "   source $SCRIPT_DIR/icyaml_docker_aliases.sh"
echo ""
echo "   Then you can use:"
echo "   icyaml-outliers --dir /data/cfa"
echo "   icyaml-query --dir /data/cfa --query \"select name from metadata when kind is Deployment\""
echo "   icyaml-analyze-cfa"
echo ""
