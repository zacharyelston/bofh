...
chmod +x "$(dirname "$0")/catalog_cfa_atlas.sh"
chmod +x "$(dirname "$0")/query_cfa_atlas.sh"
chmod +x "$(dirname "$0")/find_outliers.sh"
chmod +x "$(dirname "$0")/analyze_cfa_outliers.sh"
...
echo "  ./analyze_cfa_outliers.sh             # Analyze YAML configuration files for outliers"
echo ""
echo "Ready-to-use scripts:"
echo "  ./catalog_cfa_atlas.sh               # Scan YAML configuration files"
echo "  ./query_cfa_atlas.sh deployments     # Find deployments in YAML configuration files"
echo "  ./query_cfa_atlas.sh custom \"query\"  # Custom query on YAML configuration files"
echo ""
